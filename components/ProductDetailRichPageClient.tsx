...
export default function ProductDetailRichPageClient({ productId }: Props) {
  ...
  return (
    ...
    <div className="h-screen bg-digitalby text-white overflow-y-auto overscroll-contain">
      <BottomLeftControls />
      ...
      <div className="mx-auto max-w-6xl px-6 pb-20 -mt-10 pt-6 relative z-10">
